...
namespace Snake
{
    public class GameState
    {
        ...
        public Position HeadPosition() { return snakePositions.First.Value; }
        public Position TailPosition() { return snakePositions.Last.Value; }
        ...
        {
            if (dirChanges.Count == 2) return true;
        ...
        {
            if (OutsideGrid(pos)) return GridValue.Outside;
            if (pos == TailPosition()) return GridValue.Empty;
        ...
        public void Move()
        {
            ...
            Position pos = HeadPosition().Translate(Dir);
            GridValue hit = WillHit(pos);
